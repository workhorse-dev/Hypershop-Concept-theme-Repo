class CookieBanner extends ModalElement{constructor(){super();if(!theme.config.isTouch||Shopify.designMode){this.init()}else{new theme.initWhenVisible(theme.utils.throttle(this.init.bind(this)))}}
